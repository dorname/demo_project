{
    ...
    configs: [{
            ...
            type: 'boolean',
            defaultValue: false,
            doc: '上传缩略图（小图标）开关（注：打开此属性后uploadParams，uploadFileParam,'+
			'isMultiple，submitUrl以及uploadHandler，uploadSuccess,uploadFailure均失效'+
			'且需要配置thumbIndex参考thumbIndex属性'
        }, {
            ...
            doc: '缩略图上传成功回调函数（仅在上传后变换上传图标时使用）'
        }
    ]
}
