    ...
    messageAlert: function (cfg, fn, scope) {
		...
		**/
		...
		document.onclick = function (docEl) {
            if (!Ext.Array.contains(docEl.srcElement.classList, "x-messagebox-body-el")
                 && !Ext.Array.contains(docEl.srcElement.classList, "x-innerhtml")
                 && !Ext.Array.contains(docEl.srcElement.classList, "x-text-el")
                 && !Ext.Array.contains(docEl.srcElement.classList, "x-messageboxtitle")
                 && !Ext.Array.contains(docEl.srcElement.classList, "x-toolbar-body-el")) {
